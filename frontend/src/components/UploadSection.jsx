...
const sampleImages = [
  {
    ...
    file: "https://agritech.tnau.ac.in/crop_protection/chilli-disease-bact.jpg",
  },
  {
    name: "Healthy Leaf",
    file: "https://i0.wp.com/post.healthline.com/wp-content/uploads/2021/11/saluyot-jute-leaves-1296x728-header.jpg?w=1155&h=1528",
  },
  {
    name: "Powdery Mildew",
    file: "https://cdn-cpkmo.nitrocdn.com/uhuJjDbJydsALGbJjNkVPvwzNkEOMBRc/assets/images/optimized/rev-a201b38/frontierlandscaping.com/wp-content/uploads/2022/04/bigstock-powdery-mildew-on-norway-maple.jpg",
  },
];
    ...
    <div className="w-full h-full flex flex-col items-center justify-center">
              ...
              {sampleImages.map((sample) => (
                ...
                >
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent flex flex-col items-start justify-end p-3 opacity-100">
                    ...
                    <span className="bg-emerald-600 text-white text-xs px-2 py-1 rounded mt-1">
                      Select
                    </span>
                  </div>
                </button>
      ...
      <div
        className={`flex flex-col items-center justify-center w-full h-full ${
          dragActive ? "bg-emerald-50" : "bg-gray-900"
        } transition-all`}
